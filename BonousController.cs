...
public class BonousController : MonoBehaviour
{
    public float speed = 0.1f;          // Reduced initial speed of the enemy
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.tag == "Missile")
        {
            ...
            if (player != null)
            {
                player.IncreaseScore(2); // Call the method to increase the score
            }
    ...
    private IEnumerator IncreaseSpeedOverTime()
    {
        while (true)
        {
            ...
            Debug.Log("Bonous speed increased to: " + speed);
        }
    }
}
